...
export const CATEGORIES = [
  { id: 'Reading',     label: '読む', label_en: 'Reading',    icon: <BookOpen size={16}/>,       color: '#2a78d6' },
  { id: 'Listening',   label: '聞く', label_en: 'Listening',  icon: <Headphones size={16}/>,     color: '#15803d' },
  { id: 'Speaking',    label: '話す', label_en: 'Speaking',   icon: <MessageCircle size={16}/>,  color: '#db2777' },
  { id: 'Writing',     label: '書く', label_en: 'Writing',    icon: <PenTool size={16}/>,        color: '#eda100' },
  { id: 'Vocabulary',  label: '単語', label_en: 'Vocab',      icon: <Book size={16}/>,           color: '#4a3aa7' },
  { id: 'ReadingAloud',label: '音読', label_en: 'Read Aloud', icon: <Mic size={16}/>,            color: '#0e9aa7' },
  { id: 'Class',       label: '授業', label_en: 'Class',      icon: <GraduationCap size={16}/>,  color: '#eb6834' },
];
